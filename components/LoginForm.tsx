...
export function LoginForm({ onSubmit, onSignUp, className }: LoginFormProps) {
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');

  return (
    <View style={styles.container} testID={cn('login-form', className)}>
      <Card>
        <CardContent>
          <View style={styles.form}>
            <View style={styles.header}>
              <Text style={styles.title}>Welcome back</Text>
              <Text style={styles.subtitle}>Login to your Acme Inc account</Text>
            </View>
            ...
            <View style={styles.footerRow}>
              ...
              <Text style={[styles.smallText, styles.link]} onPress={onSignUp}>Sign up</Text>
            </View>
          </View>
